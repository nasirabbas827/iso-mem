...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err) && empty($email_err) && empty($phone_err)) {
        $sql = "INSERT INTO users (username, password, email, phone, status) VALUES (?, ?, ?, ?, 'pending')";
        $stmt = mysqli_prepare($conn, $sql);
        ...
        mysqli_close($conn);
        echo '<div class="alert alert-success" role="alert">User registered successfully. Your Status is pending Wait for Admin Approval.</div>';
    }
